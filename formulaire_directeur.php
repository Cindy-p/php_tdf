			...
			<!-- NOM ---------------------------------------------------- -->
                ...
                <?php if($isValidNom){ ?>
                  <div class="control-group">    
                      ...
                      <div class="controls">
                          <input type="text" name="nomDirecteur" id="nomDirecteur" placeholder="Nom" value="<?php verifRempli('nomDirecteur'); ?>" maxlength="40" required> 
                      </div>
                  </div>
                <?php }else{ ?>
                  <div class="control-group error">
                      <label class="control-label" for="nomDirecteur">Nom*</label>
                      <div class="controls">
                          <input type="text" name="nomDirecteur" id="nomDirecteur" maxlength = "40" required>
			...
			<!-- PRENOM ----------------------------------------------------  -->
                ...
                <?php if($isValidPrenom){ ?>            
                    <div class="control-group">    
                        ...
                        <div class="controls">
                            <input type="text" name="prenomDirecteur" id="prenomDirecteur" placeholder="Prénom" value="<?php verifRempli('prenomDirecteur'); ?>" maxlength="40" required>
                        </div>
                    </div>
                <?php }else{ ?>
                  <div class="control-group error">
                      ...
                      <div class="controls">
                          <input type="text" name="prenomDirecteur" id="prenomDirecteur" maxlength = "40" required>
