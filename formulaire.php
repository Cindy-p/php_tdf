            ...
            <!-- NOM ---------------------------------------------------- -->
                ...
                <?php if($isValidNom){ ?>
                  <div class="control-group">    
                      ...
                      <div class="controls">
                          <input type="text" name="nomCoureur" id="nomCoureur" placeholder="Nom" value="<?php verifRempli('nomCoureur'); ?>" maxlength="30" required> <!-- modif -->
                      </div>
                  </div>
                <?php }else{ ?>
            ...
            <!-- PRENOM ----------------------------------------------------  -->
                ...
                <?php if($isValidPrenom){ ?>            
                    <div class="control-group">    
                        ...
                        <div class="controls">
                            <input type="text" name="prenomCoureur" id="prenomCoureur" placeholder="Prénom" value="<?php verifRempli('prenomCoureur'); ?>" maxlength="30" required> <!-- modif -->
                        </div>
                    </div>
                <?php }else{ ?>
                  <div class="control-group error">
                    ...
                    <div class="controls">
                        <select name="anneeNaissance" id="anneeNaissance" size="1">
                            ...
                            <?php for ($i=1900 ; $i<=(date('Y')-17) ; $i++): ?>
                                <option value="<?php echo $i; ?>" <?php verifSelect('anneeNaissance', $i); ?>> <?php echo $i; ?> </option> <!-- modif -->
                            <?php endfor; ?>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="controls">
                        <select name="nomPays" id="nomPays" size="1" required>
                            ...
                            <?php
                                ...
                                while ($donnees = $req->fetch()) { ?> <!-- modif -->
                                    <option value="<?php echo $donnees['NOM']; ?>" <?php verifSelect('nomPays', $donnees['NOM']); ?> > <?php echo $donnees['NOM']; ?> </option> <!-- modif -->
                            <?php } ?> <!-- modif -->
                        </select>
                    </div>
                </div>
                    ...
                    <div class="controls">
                        <select name="anneeTdf" id="anneeTdf" size="1">
                            ...
                            <?php
                                ...
                                while ($donnees = $req->fetch()) { ?> <!-- modif -->
                                    <option value="<?php echo $donnees['ANNEE']; ?>" <?php verifSelect('anneeTdf', $donnees['ANNEE']); ?> > <?php echo $donnees['ANNEE']; ?> </option> <!-- modif -->
                            <?php } ?> <!-- modif -->
                        </select>
                    </div>
                </div>
